...
angular.module('mobileAngular').factory("Backend", function(localStorage){
...
angular.module('mobileAngular').factory("Mission", function ($q, $rootScope, SyncedResourceService){
	var storeWrapper = {
		store: undefined,
		getStore: function() {
			var deferred = $q.defer();
