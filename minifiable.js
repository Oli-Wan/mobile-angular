...
mobileAngular.config([
...
]), mobileAngular.directive('ngDrag', [
  '$parse',
  function () {
    return {
      restrict: 'E',
  ...
  '$window',
  function (a, b, c, d) {
    console.log('Hello world'), b.getAll().then(function (b) {
      a.missions = b;
    }), a.$on('dataChanged', function () {
      b.getAll().then(function (b) {
        a.missions = b;
...
mobileAngular.run([
  ...
  'Backend',
  '$rootScope',
  function (SocketService, $http, ClientID, CommandUtils, localStorage, Backend, $rootScope) {
    var fetch = function () {
